...
export default function Redis({ className }: { className?: string }): React.JSX.Element {
  return (
    <svg stroke="#FF4438" fill="#FF4438" strokeWidth="0" viewBox="0 0 24 24" className={cn("size-3.5", className)} height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
